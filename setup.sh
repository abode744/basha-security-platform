...
echo ""
echo "🛠️ ترسانة الفحص الأمني المدمجة (75 أداة متقدمة نشطة 100%):"
echo "   - الاستكشاف والنطاقات  : subfinder, assetfinder, sublist3r, findomain, altdns, amass, subzy, dnsx, dig, massdns, dnsrecon, fierce, whois"
echo "   - التهديدات والاستخبارات: shodan, spiderfoot, theHarvester, checkdmarc, spoofcheck, crtsh"
echo "   - مسح المنافذ والشبكة  : nmap, masscan, rustscan, naabu, netcat, zmap, openssl, sslscan, sslyze, testssl"
echo "   - فحص الويب والمسارات  : httpx, katana, kiterunner, graphql-cop, gau, waybackurls, whatweb, wafw00f, paramspider, arjun"
echo "   - التنقيب والسحابة والتسريبات : ffuf, gobuster, feroxbuster, dirsearch, gitdumper, gitleaks, trufflehog, cloud_enum, prowler, scoutsuite"
echo "   - فحص الثغرات والحقن   : sqlmap, dalfox, commix, crlfsuite, ghauri, nuclei, cve_auditor, nikto, wpscan, corsy, securityheaders"
echo ""
